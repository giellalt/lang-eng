...
[![Maturity](https://github.com/giellalt/lang-eng/raw/generated/docs-data/fst-maturity.svg)](https://giellalt.github.io/MaturityClassification.html)
![Lemma count](https://github.com/giellalt/lang-eng/raw/generated/docs-data/fst-lemmacount.svg)
[![Speller suggestion quality](https://github.com/giellalt/lang-eng/raw/generated/docs-data/speller-suggestions.svg)](https://giellalt.github.io/lang-eng/typosreport/)
...
[![Doc build](https://img.shields.io/github/actions/workflow/status/giellalt/lang-eng/docs.yml?logo=github&label=DocCI)](https://github.com/giellalt/lang-eng/actions/workflows/docs.yml)
[![Build Status](https://builds.giellalt.org/api/badge/lang-eng?logo=buildkite&label=CoreCI)](https://builds.giellalt.org/pipelines/lang-eng/builds/latest)

Download nightly / CI/CD installation packages for testing (contains the core zhfst file(s)):

[![Windows](https://img.shields.io/badge/download%40latest-Windows--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-eng?platform=windows&channel=nightly)
[![MacOS](https://img.shields.io/badge/download%40latest-macOS--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-eng?platform=macos&channel=nightly)
[![Mobile](https://img.shields.io/badge/download%40latest-mobile--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-eng?platform=mobile&channel=nightly)
...
Install proofing tools and [keyboards](https://github.com/giellalt/keyboard-eng)
for the English language by using the [Divvun Installer](http://divvun.no)
...
- [Language specific documentation](https://giellalt.github.io/lang-eng/)
- [General documentation](https://giellalt.github.io/)

Core dependencies
-----------------

In order to compile and use English language morphology and
...
Using Git:
```
git clone https://github.com/giellalt/lang-eng
```

Using Subversion:
```
svn checkout https://github.com/giellalt/lang-eng.git/trunk lang-eng
```
