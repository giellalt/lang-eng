...
This directory contains source files for the English language morphology
...
analyser. Documentation can be found here:

-   <https://giellalt.uit.no/lang/eng/index.html> (analyser)
...
The English language sources can be acquired using [giella SVN
